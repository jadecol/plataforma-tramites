//package com.gestion.tramites.service; // Paquete correcto
//
...
//import com.gestion.tramites.excepciones.ResourceNotFoundException; // Importa tu excepción personalizada
//
...
//        // Opcional: Validar que el NIT no exista ya antes de guardar
//        // if (entidadRepository.findByNit(entidad.getNit()).isPresent()) {
//        //    throw new IllegalArgumentException("Ya existe una entidad con este NIT.");
//        // }
...
//
//    @Transactional(readOnly = true)
//    public Optional<Entidad> obtenerEntidadPorId(Long id) {
//        return entidadRepository.findById(id);
//    }
//
//    @Transactional
//    public Entidad actualizarEntidad(Long id, Entidad entidadActualizada) {
...
//            entidad.setEmail(entidadActualizada.getEmail());
//            entidad.setSitioWeb(entidadActualizada.getSitioWeb());
//            entidad.setActivo(entidadActualizada.isActivo());
//            return entidadRepository.save(entidad);
//        }).orElseThrow(() -> new ResourceNotFoundException("Entidad", "id", id)); // Usa tu excepción
//    }
//
//    @Transactional
//    public void eliminarEntidad(Long id) {
//        // Verifica si la entidad existe antes de intentar eliminarla
...
//
//    @Transactional
//    public Entidad cambiarEstadoEntidad(Long id, boolean nuevoEstado) {
//        return entidadRepository.findById(id).map(entidad -> {
