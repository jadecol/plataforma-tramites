...
//    }
//
//    // Puedes añadir constructores si te son útiles para mapeo
//    // Por ejemplo, para construir un DTO a partir de una entidad Solicitud
//    // (esto se podría hacer en el servicio también)
//
